...
**If you use a build server, you may also have to add https://www.myget.org/F/exceptionless/ as a package source in your (http://docs.nuget.org/docs/reference/nuget-config-settings "NuGet config settings").**
